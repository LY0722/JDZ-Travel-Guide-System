...
const _sfc_main = {
  ...
  methods: {
    addDebugLog(message) {
      ...
      common_vendor.index.__f__("log", "at pages/shop/favorite.vue:45", message);
    },
    async checkFavorite() {
      if (this.checking)
        return;
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/shop/favorite.vue:72", "检查收藏状态失败:", e);
        this.isFavorite = false;
        this.favoriteId = null;
      } finally {
        this.checking = false;
    ...
    async toggleFavorite() {
      ...
      if (this.isFavorite) {
        ...
        try {
          ...
          common_vendor.index.__f__("error", "at pages/shop/favorite.vue:119", e);
        ...
        try {
          ...
          common_vendor.index.__f__("error", "at pages/shop/favorite.vue:145", e);
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-b2fea33c"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/shop/favorite.js.map
